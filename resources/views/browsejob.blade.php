				...
				<div class="container">
					<div class="row">
						<div class="col-xl-9 col-lg-8">
							<h5 class="widget-title font-weight-700 text-uppercase">{{$categoryName}}</h5>
						...
						<div class="col-xl-3 col-lg-4">
							<div class="sticky-top">
								...
								<div class="clearfix">
									<h5 class="widget-title font-weight-700 text-uppercase">Categories</h5>
											<div class="job-post-info" style="background-color: #F9FAFF;">
											
												<ul >
													@foreach($categories as $category)

													<li class="{{request()->category == $category->slug ? 'active' : ''}}"><a href="{{route('browsejob', ['category'=>$category->slug]) }}" style="color:black;text-transform:uppercase;">{{$category->name}}</a> </li>
